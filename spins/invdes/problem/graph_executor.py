...
def eval_fun(
        ...
        save_folder: Optional[str] = None) -> Union[List[np.ndarray], np.ndarray]:
    ...
    _eval_fun_vals(fun_vals, fun_map, graph, top_sorted_nodes, param, save_folder)
...
def _eval_fun_vals(fun_vals: Dict[NodeId, np.ndarray], fun_map: FunctionMap,
    ...
    def _eval_fun(node, input_vals):
        ...
        return fun_map[node].eval(input_vals, save_folder)
...
def eval_grad(fun: "OptimizationFunction",
    ...
    # behavior to `WaveguideModeOverlap`.

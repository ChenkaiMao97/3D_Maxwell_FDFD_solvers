...
def get_integrated_photonics_challenge(
    ...
    spec = IntegratedPhotonicsSpec(
        ...
        wg_eps = wg_eps,
        wg_min_separation = wg_min_separation,
    ...
    constructor = partial(IntegratedPhotonicsProblem, 
        spec=spec
    )
...
# @gin.configurable
# def get_metasurface_challenge(
#     key: jax.Array,
#     wavelengths_mm: List[float],
# ):
#     return MetasurfaceChallenge(wavelengths_mm=wavelengths_mm)

# @gin.configurable
# def get_coupling_challenge(
#     key: jax.Array,
#     wavelengths_nm: List[float],
#     focus_positions_nm: List[Tuple[float, float]],
# ):
#     return CouplingChallenge(wavelengths_nm=wavelengths_nm, focus_positions_nm=focus_positions_nm)
